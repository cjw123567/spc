...
<div class="top">
	<form class="form-horizontal" id="form1" enctype="multipart/form-data" method="post">
		...
		<div class="form-box">
			...
			<div> <button type="button" class="btn btn-primary btn-main" id="QueryOK">查詢</button></div>
		</div>
	</form>
</div>

<div class="bottom" style = "overflow:auto">
	<table class="table table-hover table-bordered show-table" style="width: 3200px;" id="linkManageTable">
		<thead>
		<tr>
			<th>日期時間</th>
			<th>尺寸/工站號</th>
